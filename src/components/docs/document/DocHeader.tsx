...
function GitHubIcon() {
  return (
    <svg width="13" height="13" viewBox="0 0 16 16" fill="#000000" aria-hidden="true">
...
function LinkedInIcon() {
  return (
    <svg width="13" height="13" viewBox="0 0 16 16" fill="#0A66C2" aria-hidden="true">
    ...
    <div className="text-center mb-6">
      ...
      >
        <a
          ...
          style={{ color: "var(--docs-text-muted)", textDecoration: "none" }}
          onMouseEnter={e => (e.currentTarget.style.color = "var(--docs-accent)")}
